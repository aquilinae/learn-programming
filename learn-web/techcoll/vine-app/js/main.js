...
function eventHandler() {
    ...
    // прячем интро и показываем список айтемов
    var button = document.getElementById('button-catalog')
    button.addEventListener('click', function() {
      document.getElementById('intro').style.display = 'none';
      document.getElementById('content').style.display = 'inline-block';
      document.getElementById('oper-pane').style.display = 'block';
    });

    // имплемантация наполнения корзины
    var count = 0, total = 0;
